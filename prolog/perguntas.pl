...
%p6 intervenção foi realmente positiva ?
intervenção(X,Y) ; negativo(X,Y)

%p7 o discurso de política de confrontos é eleitoreiro, ou seja, ele propunha algo antes e mudou o discurso em poucos meses?
discursoEleitoreiro(politicaDeConfrontos, politicaDeAbates)

%p8 o candidato quer de fato combater a corrupção?
querCombater(corrupcao, aryFerreira)

%p9 Witzel pode ser considerado um corruptor?
corruptor(witzel)


%p10 militares sao incorruptiveis
naoCorrupto(militar)
