...
/* fatos e regras para pergunta de corruptor sobre o Witzel 
 * Fonte de engenharia de gratificação de acúmulo: https://www.youtube.com/watch?time_continue=78&v=ayMIIrKsZKM
 * Para fins de teste, dizemos que o candidato não pratica outros atos de corrupção*/
ensina(engenharia, gratificacaoDeAcumulo, witzel).
naoPratica(outrosAtosCorrupcao).
corruptor(X) :- ensina(engenharia, gratificacaoDeAcumulo, X) ; not(naoPratica(outrosAtosCorrupcao)).
